...
extern void paging_manager_swap_system_page_directory(paging_manager_t* paging_manager, uint32_t cr3, bool is_physical);

extern void paging_manager_set_as_system_paging(paging_manager_t* paging_manager, bool is_physical);
